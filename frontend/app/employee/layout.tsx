...
import { Menu, Home, CircleCheck, ListCheck, LogOut, X } from "lucide-react";
    ...
    <div className="flex h-screen bg-background text-foreground">
      ...
      >
        <div className="p-4 flex items-center justify-between">
          {sidebarOpen && (
            <h1 className="text-xl font-bold tracking-wide text-foreground">Employee Panel</h1>
          )}
      ...
      >
        <div className="p-4 flex items-center justify-between border-b border-border">
          <h1 className="text-xl font-bold tracking-wide">Employee Panel</h1>
