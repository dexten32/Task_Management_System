...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 text-muted-foreground/80 hover:text-muted-foreground data-[state=open]:bg-card data-[state=open]:text-muted-foreground">
        <X className="h-5 w-5" />
